        ...
        <>
          ...
          <div className="relative pb-[273px]">
            <img
              src={banner}
              alt=""
              className="h-[135px] w-full md:h-[424px]"
            />
            <img
              src={subBanner}
              alt=""
            ...
            <p className="font-primary line-h absolute top-[91px] left-[24px] w-[183px] text-[42px]/[50px] font-extrabold md:top-[337px] md:left-[135px] md:w-[700px] md:text-[160px]/[180px]">
              Wear the best
              <img
                src={decor}
                alt=""
          ...
          <div className="container mx-auto mt-[150px] flex gap-[30px] px-8">
            <div className="flex flex-1 flex-col items-center bg-[#FAFAFA] pt-[64px] pb-[34px]">
              <div className="inline-block rounded-full bg-[#E5E5E5] p-[30px]">
                <svg
              ...
              <p className="font-secondary w-[242px] text-center text-[25px]/[35px] font-bold">
          ...
          <div className="container mx-auto mt-[150px] px-8">
            <p className="font-secondary text-dark mb-[70px] text-[42px] font-bold">
              Featured Products
            </p>
            <div className="flex items-center justify-center gap-[30px]">
              {products.map((product) => (
            ...
            <div className="mt-[70px] text-center">
              <div className="bg-primary font-secondary inline-flex items-center justify-center px-9 py-4 text-white">
                View All
              </div>
            </div>
          </div>
          ...
          {/* promotion section */}
          <div className="mt-[150px] bg-[#F1DEB4] py-20">
          ...
          <div className="bg-primary mt-[150px] px-8 py-[100px]">
            <div className="container mx-auto flex max-w-[570px] flex-col gap-[30px]">
              <p className="font-secondary text-[42px]/[52px] font-bold text-white">
              ...
              <div className="flex gap-4">
                <input
                  ...
                  className="w-full rounded-xl border-[1px] border-white px-5 py-4 outline-none"
                />
                <button className="text-primary font-secondary rounded-xl bg-[#FFD44D] px-9 py-4 text-[18px] font-medium">
                  Subcribe
                </button>
              </div>
            </div>
