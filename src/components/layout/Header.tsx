  ...
  return (
    <div className="bg-primary">
      <div className="container mx-auto flex flex-wrap items-center justify-between px-8 py-4">
        ...
        <div className="ml-auto flex items-center gap-5 md:order-3 md:ml-0">
          {/* User Icon */}
          {user?.name ? (
            <div className="group relative cursor-pointer text-white">
              {/* Khối User */}
              ...
              {/* Dropdown Box */}
              <div className="absolute top-full right-0 z-50 hidden min-w-[150px] rounded-lg bg-white p-3 pt-2 text-black shadow-md group-hover:block">
                <button
                  className="block w-full rounded px-2 py-1 text-left hover:bg-gray-200"
          ...
          <div className="relative">
            <FaRegHeart className="text-2xl text-white"></FaRegHeart>

            {cart >= 0 && (
              <span className="text-primary absolute top-[-7px] right-[-5px] flex h-4 w-4 items-center justify-center rounded-full bg-white text-xs font-bold">
                {cart}
              </span>
            )}
          </div>
        ...
        {/* Search Box */}
        <div className="mt-5 flex basis-full items-center justify-between md:order-2 md:mt-0 md:basis-2xl md:justify-center">
          {/* Menu */}
          <div className="flex items-center gap-1 md:hidden">
            ...
            <p className="font-secondary text-[14px]/[20px] text-white">Menu</p>
          </div>
          {/* Search block */}
          <div className="relative flex w-[60%] items-center">
            <input
              ...
              value={searchText}
              className="placeholder:font-secondary h-10 w-full border border-white px-4 placeholder:text-sm placeholder:text-white md:h-11"
            />
            ...
            {suggestions && searchText && (
              <div className="absolute top-full left-0 z-50 mt-1 max-h-60 w-full overflow-y-auto rounded border border-gray-300 bg-white shadow">
