...
export const ReviewForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-[55px] w-full rounded-lg p-6">
      {/* Đánh giá sao */}
      <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="focus:ring-primary w-full rounded-lg border border-gray-300 p-2 focus:ring-2 focus:outline-none"
        />
      </div>
      ...
      <button
        type="submit"
        className="bg-primary hover:bg-primary-dark rounded-lg px-9 py-4 font-semibold text-white transition"
      >
        Submit Review
      </button>
    </form>
